# Tool Design Guide for Claude Code Skills & Agents

Reference guide for designing effective skills and agents based on Anthropic's "Writing Tools for Agents" best practices.
...
```yaml
---
description: Validates ROS2 node implementation  # ❌ Too vague

description: Validates ROS2 node implementation against best practices including parameter declaration, proper initialization, QoS configuration, and logging patterns  # ✅ Clear and specific
---
```
...
- Limit output to first N items by default
- Provide guidance on how to narrow search
- Offer filters or parameters to reduce results
